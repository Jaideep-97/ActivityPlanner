...
@Component(value = "BalanceCalcForStandardPassengers")
@Primary
public class BalanceCalcForStandardPassengers extends BalanceStrategy {
    ...
    public void updateBalanceForUser(Long userId, String activityName) {
        ...
        Double balanceLeft = balance.getBalanceLeft() - activity.getCost();
